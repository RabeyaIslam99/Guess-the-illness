...
# Heading
w2 = Label(root, justify=LEFT, text="Guess The ilness", fg="white", bg="black")
...
dst = Button(root, text="DecisionTree", command=DecisionTree,bg="sky blue",fg="yellow")
dst.grid(row=15, column=0, pady=10,sticky=W)

rnf = Button(root, text="Randomforest", command=randomforest,bg="sky blue",fg="yellow")
rnf.grid(row=17, column=0, pady=10, sticky=W)

lr = Button(root, text="NaiveBayes", command=NaiveBayes,bg="sky blue",fg="yellow")
